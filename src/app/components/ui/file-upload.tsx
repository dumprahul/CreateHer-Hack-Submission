...
export const FileUpload = ({
  ...
  return (
    <div className="w-full max-w-md mx-auto" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
            ...
            {files.length > 0 &&
              files.map((file, idx) => (
                <motion.div
                  ...
                  className={cn(
                    "relative overflow-hidden z-40 bg-white dark:bg-neutral-900 flex flex-col items-start justify-start md:h-24 p-3 mt-2 w-full mx-auto rounded-md",
                    "shadow-sm"
                  )}
                >
